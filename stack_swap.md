...
pop rsi
```
1. `push rdi & push rsi` pushes the value stored in the respective registers onto the stack.
2. `pop rdi & pop rsi` rdi gets the top most value stored on the stack and rsi gets the value stored below it.
